...
Invoked by ``miho kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Miho Agent board.
...
def _profile_author() -> str:
    """Mirror of ``miho_cli.kanban._profile_author``."""
    return (
