...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("evolution", "Auditable Miho evolution ledger, snapshots, rollbacks, and System WikiGraph",
               ...
               subcommands=("status", "list", "ls", "show", "snapshot", "rollback", "record", "mine", "propose", "validate", "promote", "cycle", "train", "immunity", "doctor", "autopilot", "wikigraph", "wg", "query", "visualize", "viz", "install-hooks", "watch-once")),
