...
Used by ``miho profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``miho_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Miho Agent kanban board.
...
Rules:
  ...
  - Never write "Miho Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_miho_home())
        else:
