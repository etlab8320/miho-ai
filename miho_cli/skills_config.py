"""
Skills configuration for Miho Agent.
`miho skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.miho/config.yaml under:
...
from miho_cli.config import cfg_get, load_config, save_config
from miho_cli.colors import Colors, color
from miho_cli.platforms import PLATFORMS as _PLATFORMS
