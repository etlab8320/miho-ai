 ...
 * `window.__MIHO_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Miho brand in the top bar
 ...
 *  `window.__MIHO_PLUGINS__.registerSlot(...)`.
 *
