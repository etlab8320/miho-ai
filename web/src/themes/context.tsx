...
const STORAGE_KEY = "miho-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `miho_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "miho-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-miho-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-miho-theme-font", "true");
