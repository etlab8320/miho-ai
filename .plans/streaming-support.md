# Streaming LLM Response Support for Miho Agent
...
```
MIHO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("MIHO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `miho_cli/config.py` | 1 | +streaming config defaults |
