...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("miho_cli.config.get_config_path", return_value=config_path), \
             patch("miho_cli.config.ensure_miho_home"):
    ...
    def test_ensure_miho_home_sets_0700(self):
        home = Path(self.tmpdir) / ".miho"
        with patch("miho_cli.config.get_miho_home", return_value=home):
