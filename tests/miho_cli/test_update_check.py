"""Tests for the update check mechanism in miho_cli.banner."""
...
def test_invalidate_update_cache_clears_all_profiles(tmp_path):
    ...
    from miho_cli.main import _invalidate_update_cache

    # Build a fake ~/.miho with default + two named profiles
    ...
    with patch.object(Path, "home", return_value=tmp_path), \
         patch.dict(os.environ, {"MIHO_HOME": str(default_home)}):
