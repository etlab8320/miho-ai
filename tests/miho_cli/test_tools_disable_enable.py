"""Tests for miho tools disable/enable/list command (backend)."""
...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("miho_cli.tools_config.load_config", return_value=config), \
             patch("miho_cli.tools_config.save_config") as mock_save:
