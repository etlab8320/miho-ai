"""Tests for `miho curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import miho_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated MIHO_HOME with real agent-created skills on disk."""
    home = tmp_path / ".miho"
    skills = home / "skills"
    ...
    from miho_cli import curator as curator_cli
