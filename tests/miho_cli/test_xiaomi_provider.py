...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from miho_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in MIHO_OVERLAYS
        overlay = MIHO_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify miho doctor recognizes Xiaomi env vars."""
