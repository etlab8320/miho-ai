"""Tests for the interactive session browser (`miho sessions browse`).
...
from miho_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """miho sessions browse should be parseable."""
        from miho_cli.main import main as _main_entry
