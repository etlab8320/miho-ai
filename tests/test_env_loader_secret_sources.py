"""Tests for the secret-source tracking in ``miho_cli.env_loader``.

These cover the small public surface that lets `miho model` / `miho setup`
...
from miho_cli import env_loader  # noqa: E402
