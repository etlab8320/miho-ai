...
def worker_loop(worker_id: int, miho_home: str, result_file: str) -> None:
...
def reclaimer_loop(miho_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="miho_mixed_stress_")
    print(f"MIHO_HOME = {home}")
