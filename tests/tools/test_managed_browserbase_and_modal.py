...
def _enable_managed_nous_tools(monkeypatch):
    ...
    miho_cli.auth and miho_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("miho_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("miho_cli.models.check_nous_free_tier", lambda: False)
