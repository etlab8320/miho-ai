...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_miho_home_override(self, tmp_path):
        """Auth lookup should read from MIHO_HOME/auth.json, not ~/.miho/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".miho").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``miho tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
