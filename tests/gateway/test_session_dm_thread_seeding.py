...
def store(tmp_path, monkeypatch):
    ...
    ~/.miho/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at miho_state import time, before pytest's MIHO_HOME monkeypatch
    fires — the autouse fixture's MIHO_HOME override doesn't help here.)
    """
    import miho_state
