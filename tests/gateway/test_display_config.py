...
class TestPlatformDefaults:
    ...
    def test_high_tier_platforms(self):
        """Discord defaults to clean progress; Telegram defaults to new."""
        from gateway.display_config import resolve_display_setting

        # Telegram: tier_high member with tool_progress="new" override.
        assert resolve_display_setting({}, "telegram", "tool_progress") == "new"
        # Discord: chat UX hides internal tool names by default.
        assert resolve_display_setting({}, "discord", "tool_progress") == "clean"
...
class TestConfigMigration:
    ...
    def test_migration_creates_platforms_entries(self, tmp_path, monkeypatch):
        ...
        # Re-import to pick up the new MIHO_HOME
        import importlib
