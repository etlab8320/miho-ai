"""Tests for miho-api-server toolset and API server tool availability."""
import os
import json
...
class TestMihoApiServerToolset:
    """Tests for the miho-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("miho-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("miho-api-server")

    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("miho-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "miho-api-server"
...
class TestApiServerAdapterToolset:
    ...
    def test_create_agent_reads_config_toolsets(self):
        ...
        with patch("gateway.run._resolve_runtime_agent_kwargs") as mock_kwargs, \
            ...
            # No platform_toolsets override — should fall back to miho-api-server default
