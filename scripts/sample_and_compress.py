...
DEFAULT_DATASETS = [
    ...
    "NousResearch/miho-agent-megascience-sft1",
    "NousResearch/Miho-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Miho-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-miho-agent"
]
