#!/usr/bin/env python3
"""Build the Miho Model Catalog — a centralized JSON manifest of curated models.
...
Miho CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Miho release.
...
# Ensure MIHO_HOME is set for imports that touch it at module level.
os.environ.setdefault("MIHO_HOME", os.path.join(os.path.expanduser("~"), ".miho"))

from miho_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "miho-agent repo",
            "docs": "https://miho-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
