#!/usr/bin/env python3
"""Build the Miho Skills Index — a centralized JSON catalog of all skills.
...
`miho skills search/install` can use it without hitting the GitHub API.
...
# Ensure MIHO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Miho Skills Index...", flush=True)
