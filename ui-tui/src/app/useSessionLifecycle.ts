...
import type { ScrollBoxHandle } from '@miho/ink'
import { evictInkCaches } from '@miho/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.MIHO_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
