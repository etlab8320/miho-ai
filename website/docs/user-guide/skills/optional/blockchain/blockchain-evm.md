...
| | |
|---|---|
| Source | Optional — install with `miho skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Miho Agent |
| License | MIT |
...
Helper script path: `~/.miho/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.miho/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.miho/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.miho/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
