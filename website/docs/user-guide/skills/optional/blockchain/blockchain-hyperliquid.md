...
| | |
|---|---|
| Source | Optional — install with `miho skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Miho Agent |
| License | MIT |
...
The script reads `~/.miho/.env` for two optional defaults:
...
Helper script: `~/.miho/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.miho/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.miho/.env`.
...
```bash
python3 ~/.miho/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.miho/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
