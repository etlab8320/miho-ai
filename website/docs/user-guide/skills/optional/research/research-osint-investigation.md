...
| | |
|---|---|
| Source | Optional — install with `miho skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Miho Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $MIHO_OSINT_CACHE/icij/ (default: ~/.cache/miho-osint/icij/).
...
# Set MIHO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
