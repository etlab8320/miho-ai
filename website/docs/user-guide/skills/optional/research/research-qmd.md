...
| | |
|---|---|
| Source | Optional — install with `miho skills install official/research/qmd` |
...
Miho Agent via the native MCP client. This is the preferred
...
Then configure Miho Agent to connect via HTTP:
