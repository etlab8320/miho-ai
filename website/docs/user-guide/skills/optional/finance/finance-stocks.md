...
| | |
|---|---|
| Source | Optional — install with `miho skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Miho Agent |
| License | MIT |
...
```
SCRIPT=~/.miho/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.miho/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
