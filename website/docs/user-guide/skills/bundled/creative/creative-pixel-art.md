...
```python
import sys
sys.path.insert(0, "/home/teknium/.miho/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.miho/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Miho installs package this)
