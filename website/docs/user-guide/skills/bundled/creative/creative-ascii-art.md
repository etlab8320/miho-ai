...
```bash
python3 -m pyfiglet "MIHO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=MIHO&font=Slant" | boxes -d stone
```
