...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Miho Agent documentation based on your experience level and goals.'
---

# Learning Path

Miho Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Miho Agent yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Miho Agent can do.
...
Use Miho Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Miho Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Miho Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Miho](/docs/guides/use-voice-mode-with-miho)
...
:::tip
Cron jobs let Miho Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Miho Agent with your own tools and reusable skill packages.

1. [Plugins](/docs/user-guide/features/plugins)
2. [Build a Miho Plugin](/docs/guides/build-a-miho-plugin)
...
page is for built-in Miho core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Miho Agent's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how Miho Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Miho Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Miho tools programmatically | [Code Execution](/docs/user-guide/features/code-execution) |
