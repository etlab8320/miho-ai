  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Miho Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Miho &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Miho?{' '}
        <a
          href="https://github.com/NousResearch/miho-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
