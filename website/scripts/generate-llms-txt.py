#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Miho docs site.
...
Both publish at:
  https://miho-agent.nousresearch.com/docs/llms.txt
  https://miho-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://miho-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Miho as a Python Library", None),
        ("guides/use-mcp-with-miho", "Use MCP with Miho", None),
        ("guides/use-voice-mode-with-miho", "Use Voice Mode with Miho", None),
        ("guides/use-soul-with-miho", "Use SOUL.md with Miho", None),
        ("guides/build-a-miho-plugin", "Build a Miho Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Miho"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "miho-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/miho-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Miho Agent — Full Documentation\n",
        (
            "This file is the entire Miho Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Miho, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://miho-agent.nousresearch.com/docs\n",
        "Short index: https://miho-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
