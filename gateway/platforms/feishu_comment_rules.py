...
Config: ~/.miho/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.miho/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_miho_home()`` helper (MIHO_HOME-aware and
...
RULES_FILE = get_miho_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_miho_home() / "feishu_comment_pairing.json"
