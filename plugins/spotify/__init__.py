...
``_check_spotify_available()`` — when the user has not run ``miho auth
spotify``, the tools remain registered (so they appear in ``miho
...
The Spotify auth flow (``miho auth spotify``), CLI plumbing, and docs
