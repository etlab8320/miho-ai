"""ntfy platform adapter (Miho plugin).
...
``plugins/platforms/ntfy/``. The Miho plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "miho-in"              # subscribe topic (incoming)
          publish_topic: "miho-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``miho cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Miho dependency",
