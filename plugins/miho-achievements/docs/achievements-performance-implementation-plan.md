# Miho Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.miho/plugins/miho-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.miho/plugins/miho-achievements/scan_checkpoint.json`.
