...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on Miho threading encrypted reasoning back across
    ...
    OpenAI-compatible relays reject replayed encrypted blobs with HTTP 400
    invalid_encrypted_content; when that happens the retry loop disables
    replay and strips cached reasoning items for the rest of the session.
    """
