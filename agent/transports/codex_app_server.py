...
projection into Miho' display, approval bridging, transcript projection into
...
"codex_app_server"`. Miho' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("MIHO_KANBAN_TASK"):
            kanban_db = spawn_env.get("MIHO_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "MIHO_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("MIHO_HOME", os.path.expanduser("~/.miho")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "miho",
        client_title: str = "Miho Agent",
