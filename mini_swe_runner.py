#!/usr/bin/env python3
"""
SWE Runner with Miho Trajectory Format

A runner that uses Miho-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Miho-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Miho-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Miho format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Miho-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Miho-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Miho Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Miho-Agent's built-in execution environments
    and outputs trajectories in Miho-Agent format.
    """
    ...
    def _convert_to_miho_format(
        ...
        """
        Convert internal message format to Miho trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Miho trajectory format
        trajectory = self._convert_to_miho_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Miho trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Miho Trajectory Format")
    print("=" * 60)
