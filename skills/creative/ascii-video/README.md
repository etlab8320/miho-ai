...
Built for [Miho Agent](https://github.com/NousResearch/miho-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/miho-agent/skills/creative/ascii-video`](https://github.com/NousResearch/miho-agent/tree/main/skills/creative/ascii-video) via PR.
