...
def _profile_user_agent() -> str:
    """Return a ``miho-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from miho_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"miho-cli/{_ver}"
    except Exception:
        return "miho-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # miho-cli UA so the catalog endpoint is reachable.
