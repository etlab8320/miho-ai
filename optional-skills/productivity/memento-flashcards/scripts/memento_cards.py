...
Data file: $MIHO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_MIHO_HOME = Path(os.environ.get("MIHO_HOME", Path.home() / ".miho"))
DATA_DIR = _MIHO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
