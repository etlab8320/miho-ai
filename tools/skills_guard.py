...
Trust levels:
  - builtin:   Ships with Miho. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.miho/\.env|\~/\.miho/\.env',
     "miho_env_access", "critical", "exfiltration",
     "directly references Miho secrets file"),
    ...
    (r'\.miho/config\.yaml|\.miho/SOUL\.md',
     "miho_config_mod", "critical", "persistence",
     "references Miho configuration files directly"),
