...
One ``CDPSupervisor`` runs per Miho ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "miho-dialog-bridge.invalid"
...
(() => {
  if (window.__mihoDialogBridgeInstalled) return;
  window.__mihoDialogBridgeInstalled = true;
  const ENDPOINT = "http://miho-dialog-bridge.invalid/";
