...
the get_anchored_view / get_messages_around primitives in miho_state.
...
# Third-party integrations tag their sessions with MIHO_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from miho_state import DEFAULT_DB_PATH
